...
Son documentos tipo \textbf{JSON} con esquemas dinamicos que ofrecen simplicidad y potencia.
Los datos en MongoDB tienen esquemas flexibles. y las \textbf{colecciones} no obligan a mantener una estructura.
\end{columns}
\end{frame}
...
\item Auto Sharding
\item Querying
\item\textbf{Fast In Place Updates}
\item Map Reduce
\item GridFS
\item Other more...
\end{enumerate}
